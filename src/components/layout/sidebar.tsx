...
import {
  ...
  TrendingUp, CheckSquare, Headphones, Calculator, CalendarCheck,
} from 'lucide-react'
...
const navItems: NavItem[] = [
  ...
  { label: 'Tickets',        href: '/tickets',        icon: <Headphones size={17} /> },
    ...
    >
      ...
      >
        ...
        {mobile && (
          <button
            onClick={onClose}
            className="p-1.5 rounded-lg text-slate-400 hover:bg-white/8 transition-colors"
          >
            <X size={16} />
          </button>
        )}
