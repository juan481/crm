...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#070b14] text-slate-100 selection:bg-indigo-500 selection:text-white font-poppins antialiased overflow-x-hidden">
      ...
      <section id="inicio" className="relative pt-12 pb-16 md:pt-24 md:pb-24 overflow-hidden text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1 sm:px-4 sm:py-1.5 rounded-full bg-slate-900 border border-slate-700/80 text-[11px] sm:text-xs font-medium text-cyan-300 mb-6 sm:mb-8 shadow-inner max-w-[95%] sm:max-w-none">
            <span className="w-2 h-2 rounded-full bg-emerald-400 animate-ping inline-block shrink-0"></span>
            <span className="truncate sm:overflow-visible">Optimizá la gestión interna y pulverizá los tiempos de respuesta</span>
          </div>

          <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold tracking-tight text-white max-w-4xl mx-auto leading-snug sm:leading-[1.1] mb-4 sm:mb-6">
            Achicá el caos operativo. <br className="hidden sm:inline" />
          ...
          <p className="text-xs sm:text-base md:text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed mb-6 sm:mb-8 font-normal px-1 sm:px-0">
          ...
          {/* Banner de Acceso Rápido para Clientes Existentes */}
          <div
            className="inline-flex items-center gap-2.5 sm:gap-3 px-4 py-2.5 sm:px-8 sm:py-3.5 rounded-2xl sm:rounded-full border backdrop-blur-xl mb-8 sm:mb-10 shadow-lg flex-col sm:flex-row justify-center animate-landing-fade-in bg-[#00496b]/30 border-cyan-400/30 max-w-sm sm:max-w-none mx-auto"
          >
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs sm:text-base text-slate-100 font-medium">
                ¿Ya sos cliente o usuario de JustCRM?
              </span>
            </div>
            <Link
              href="/login"
              className="px-4 py-1.5 sm:px-5 sm:py-2 rounded-full text-white font-medium text-xs sm:text-sm tracking-normal shadow-md flex items-center gap-2 transition-all transform hover:scale-105 bg-[#00628e] hover:bg-[#00496b] border border-cyan-400/40 shrink-0"
            >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-10 sm:mb-14">
            <a
              href="#contacto"
              className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-3.5 rounded-full bg-[#00628e] hover:bg-[#00496b] text-white font-medium text-sm sm:text-base shadow-lg shadow-[#00628e]/25 transition-all transform hover:-translate-y-0.5 flex items-center justify-center gap-2.5 border border-cyan-400/30"
            >
            ...
            <a
              href="#funciones"
              className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-3.5 rounded-full bg-slate-900/80 hover:bg-slate-800 text-slate-200 hover:text-white font-medium text-sm sm:text-base border border-slate-800 transition-all flex items-center justify-center gap-2"
            >
      ...
      <footer className="py-10 bg-slate-950 border-t border-slate-900 text-slate-500 text-xs text-center sm:text-left">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <img src="/icono-justcrm.png" alt="JustCRM Logo" className="h-7 w-auto object-contain" />
